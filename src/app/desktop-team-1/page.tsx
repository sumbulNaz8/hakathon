...
<div className="flex justify-center items-center min-h-screen">
  <div className="text-center">
    ...
    <p className="text-lg text-gray-600 mb-6">We help small businesses with big ideas</p>

    {/* Centered Contact Information */}
    <div className="flex justify-center items-center">
      <div className="w-[985px] h-[403px] flex justify-between items-center">
        {/* Card 1 */}
        <div className="w-[327px] h-[343px]">
          <div>
            <Image src="/images/logo5.png" alt="logo" width={72} height={72} />
            <div className="w-[216px] h-[48px]">
              <h6>georgia.young@example.com</h6>
            </div>
            <div className="w-[176px] h-[24px] font-Montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] items-center">
              <h6>georgia.young@example.com</h6>
            </div>
            <div className="w-[100px] h-[24px] font-Montserrat font-bold text-[16px] leading-[24px] items-center">
              <h5>Get Support</h5>
            </div>
            <button className="text-[#23A6F0] w-[189px] h-[54px] rounded-[37px] border border-[#23A6F0] flex justify-center items-center gap-[10px]">
              <div className="text-[#23A6F0] font-Montserrat font-bold text-[14px] leading-[24px]">
                Submit Request
              </div>
            </button>
          </div>
